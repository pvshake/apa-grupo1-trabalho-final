"""
Testes unitários para o algoritmo de Programação Dinâmica.
"""
...
class TestDynamicProgrammingAlgorithm:
    """Classe de testes para o algoritmo de Programação Dinâmica."""

    def setup_method(self):
        """Configura o ambiente de teste antes de cada método."""
        self.algorithm = DynamicProgrammingAlgorithm()
    ...
    def test_contagem_instrucoes(self):
        ...
        algorithm = DynamicProgrammingAlgorithm(count_instructions=True)
