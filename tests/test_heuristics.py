"""
Testes unitários para o algoritmo Heurístico/Aproximado.
"""
...
class TestHeuristicAlgorithm:
    """Classe de testes para o algoritmo heurístico."""

    def setup_method(self):
        """Configura o ambiente de teste antes de cada método."""
        self.algorithm = HeuristicAlgorithm()
    ...
    def test_contagem_instrucoes(self):
        ...
        algorithm = HeuristicAlgorithm(count_instructions=True)
